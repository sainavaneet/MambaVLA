...
DEFAULT_DATA_ROOT = DEFAULT_PROJECTS_DIR / "RoboMani" / "data"
...
class MambaEncoderConfig:
    ...
    _target_: str = "RoboMani.MambaModel"
    d_model: int = 256
    n_layer: int = 5
    ...
    dual_route_mixer: bool = False


@dataclass
class BackboneConfig:
    """Backbone configuration."""
    _target_: str = "RoboMani.RoboManiPolicy"
...
class ActionFlowMatchingConfig:
    """Model configuration."""
    _target_: str = "RoboMani.ActionFLowMatching"
    ln: bool = False
    device: str = DEVICE
...
class ObsEncoderConfig:
    ...
    _target_: str = "RoboMani.MultiImageObsEncoder"
    ...
    rgb_model: Dict = field(default_factory=lambda: {
        '_target_': 'RoboMani.ResNetEncoder',
        'latent_dim': 256,
        'pretrained': False,
...
class LanguageEncoderConfig:
    ...
    _target_: str = "RoboMani.LangClip"
...
class ModelConfig:
    """Model configuration."""
    _target_: str = "RoboMani.RoboMani"
...
class DatasetConfig:
    ...
    _target_: str = "RoboMani.benchmark.libero.libero_dataset.LiberoDataset"
    ...
    dataset_path: str = str(DEFAULT_DATA_ROOT)
...
class SimulationConfig:
    ...
    _target_: str = "RoboMani.benchmark.libero.libero_sim.LiberoSim"
    rollouts: int = 20
    ...
    save_video_dir: str = str((DEFAULT_PROJECTS_DIR / "RoboMani" / "RoboMani_evaluation" / "videos").resolve())
...
class MainConfig:
    ...
    evaluation_seeds: List[int] = field(default_factory=lambda: [0, 1, 2])
...
def create_libero_object_config() -> MainConfig:
    ...
    config.dataset.dataset_path = str(DEFAULT_DATA_ROOT / "libero_object")
    return config
...
def create_libero_spatial_config() -> MainConfig:
    ...
    config.dataset.dataset_path = str(DEFAULT_DATA_ROOT / "libero_spatial")
    return config
...
def create_libero_goal_config() -> MainConfig:
    ...
    config.dataset.dataset_path = str(DEFAULT_DATA_ROOT / "libero_goal")
...
def create_libero_90_config() -> MainConfig:
    ...
    config.dataset.dataset_path = str(DEFAULT_DATA_ROOT / "libero_90")
